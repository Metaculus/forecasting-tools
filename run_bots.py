...
def get_default_bot_dict() -> dict[str, RunBotConfig]:  # NOSONAR
    ...
    deepnews_model = "asknews/deep-research/high-depth/claude-fable-5"  # Switched to claude-fable-5 and added podcasts source Sep 5th 2026 (per AskNews recommendation; gpt-6-astra was recommended too but the AskNews API was still rejecting it at the time). Switched to opus 4.6 Feb 23rd. Switched to high depth Feb 16th 2026. Switched from claude-sonnet-4-20250514 to sonnet 4.5 in Nov 2025. Switched from high to medium depth on Jan 2nd, 2026
