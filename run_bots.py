...
def get_default_bot_dict() -> dict[str, RunBotConfig]:  # NOSONAR
    ...
    deepnews_model = "asknews/deep-research/medium-depth/claude-sonnet-4-5-20250929"  # Switched from claude-sonnet-4-20250514 to sonnet 4.5 in Nov 2025. Switched from high to medium depth on Nov 25th, 2025
